...
cd ../devenv
git clone https://code.alephobjects.com/diffusion/CT/Cura2.git cura
...
LD_LIBRARY_PATH=./lib PYTHONPATH=cura:uranium:./lib/python3/dist-packages QT_PLUGIN_PATH=./lib/plugins QML2_IMPORT_PATH=./lib/qml QT_QPA_FONTDIR=./lib/fonts python3.4 ./bin/cura2 "$@"
EOF
chmod +x ./cura.sh
